...
export type BehaviorDatePickerProps = {
    label: string | null,
    on_change: (date: ReadingsDate) => void,
    date: ReadingsDate,
}

export default function BehaviorDatePicker({
    label,
    on_change,
    date,
}: BehaviorDatePickerProps): React.ReactElement
{
                        ...
                        textField: {
                            ...
                            sx: {
                                ".MuiPickersOutlinedInput-root": {
                                    borderRadius: theme.spacing(1),  // or any border-radius value
