# Current Bugs 
- Strongs number inspector cant click on strongs numbers
...
- Search only returning one result when restricted to only one chapter (???)
- Search button does not have a sound effect
